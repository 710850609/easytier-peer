...
def update_peers():
    ...
    try:
        print("\n[3/3] 从 astral.fan.csv 获取...")
        astral_peers = []
        csv_path = os.path.join(os.path.dirname(__file__), 'astral.fan.csv')
    ...
    # 写入文件
    output_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'peers', 'peer-list.txt')
